...
final class Context(config: Config):
  ...
  val tableHeaderCombinedChlorine = config.getString("table.header.combinedChlorine")
  val tableHeaderTotalChlorine = config.getString("table.header.totalChlorine")
  val tableHeaderPh = config.getString("table.header.ph")
