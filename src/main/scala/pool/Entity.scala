...
final case class Cleaning(id: Long = 0,
  ...
  val brushProperty = new ObjectProperty[Boolean](this, "brush", brush)
  val netProperty = new ObjectProperty[Boolean](this, "net", net)
  val skimmerBasketProperty = new ObjectProperty[Boolean](this, "skimmerBasket", skimmerBasket)
  val pumpBasketProperty = new ObjectProperty[Boolean](this, "pumpBasket", pumpBasket)
  val pumpFilterProperty = new ObjectProperty[Boolean](this, "pumpFilter", pumpFilter)
  val vacuumProperty = new ObjectProperty[Boolean](this, "vacuum", vacuum)
...
final case class Measurement(id: Long = 0,
  ...
  val freeChlorineProperty = new ObjectProperty[Int](this, "freeChlorine", freeChlorine)
  val combinedChlorineProperty = new ObjectProperty[Double](this, "combinedChlorine", combinedChlorine)
  val totalChlorineProperty = new ObjectProperty[Int](this, "totalChlorine", totalChlorine)
  val phProperty = new ObjectProperty[Double](this, "ph", ph)
  val calciumHardnessProperty = new ObjectProperty[Int](this, "calciumHardness", calciumHardness)
  val totalAlkalinityProperty = new ObjectProperty[Int](this, "totalAlkalinity", totalAlkalinity)
  val cyanuricAcidProperty = new ObjectProperty[Int](this, "cyanuricAcid", cyanuricAcid)
  val totalBromineProperty = new ObjectProperty[Int](this, "totalBromine", totalBromine)
  val temperatureProperty = new ObjectProperty[Int](this, "temperature", temperature)
...
final case class Chemical(id: Long = 0,
  ...
  val amountProperty = new ObjectProperty[Double](this, "amount", amount)
  val unitProperty = new StringProperty(this, "unit", unit.toString)
