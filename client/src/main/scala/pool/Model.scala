...
final class Model(fetcher: Fetcher) extends LazyLogging:
  ...
  def pools(): Unit =
    shouldBeInFxThread("pools should be in fx thread.")
    fetcher.call(
  ...
  def add(pool: Pool): Unit =
    shouldBeInFxThread("pool add should be in fx thread.")
    fetcher.call(
  ...
  def update(pool: Pool): Unit =
    shouldBeInFxThread("pool update should be in fx thread.")
    fetcher.call(
      SavePool(observableAccount.get.license, pool),
      (event: Event) => event match
  ...
  def measurements(poolId: Long): Unit =
    shouldBeInFxThread("measurements should be in fx thread.")
    fetcher.call(
  ...
  def add(measurement: Measurement): Unit =
    shouldBeInFxThread("measurement add should be in fx thread.")
    fetcher.call(
  ...
  def update(measurement: Measurement): Unit =
    shouldBeInFxThread("measurement update should be in fx thread.")
    fetcher.call(
      SaveMeasurement(observableAccount.get.license, measurement),
      (event: Event) => event match
  ...
  def chemicals(poolId: Long): Unit =
    shouldBeInFxThread("chemicals should be in fx thread.")
    fetcher.call(
  ...
  def add(chemical: Chemical): Unit =
    shouldBeInFxThread("chemical add should be in fx thread.")
    fetcher.call(
  ...
  def update(chemical: Chemical): Unit =
    shouldBeInFxThread("chemical update should be in fx thread.")
    fetcher.call(
      SaveChemical(observableAccount.get.license, chemical),
      (event: Event) => event match
