...
// Begin: Client Assembly
  ...
  */
  ...
  if (OS == "mac") assemblyJarName := "pool-balance-mac-0.26.jar"
  else if (OS == "mac-aarch64") assemblyJarName := "pool-balance-m1-0.26.jar"
  else if (OS == "win") assemblyJarName := "pool-balance-win-0.26.jar"
  else if (OS == "linux") assemblyJarName := "pool-balance-linux-0.26.jar"
  else assemblyJarName := "pool-balance-no-valid-target-specified-0.26.jar"
